...
- [React Native commands in the Command Palette](#react-native-commands-in-the-command-palette)
  - [Using commands in VS Code tasks](#using-commands-in-vs-code-tasks)
- [Debugging React Native applications](#debugging-react-native-applications)
  - [Hermes engine](#hermes-engine)
    - [Android Hermes](#android-hermes)
    - [iOS Hermes](#ios-hermes)
    - [macOS Hermes](#macos-hermes)
    - [Windows Hermes](#windows-hermes)
  ...
  - [React Native for Windows](#react-native-for-windows)
    - [How to launch and debug a React Native for Windows application](#how-to-launch-and-debug-a-react-native-for-windows-application)
    - [How to attach to a running React Native for Windows application](#how-to-attach-to-a-running-react-native-for-windows-application)
    - [Windows Hermes debugging](#windows-hermes-debugging)
  - [React Native for macOS](#react-native-for-macos)
...
- [Element inspector](#element-inspector)
    - [Integration with React Native Inspector](#integration-with-react-native-inspector)
- [Network Inspector](#network-inspector)
    - [Network inspector requirements](#network-inspector-requirements)
    - [Network inspector usage](#network-inspector-usage)
    - [Network inspector logs theme](#network-inspector-logs-theme)
