...
#     return render(request, 'LegacySite/giftcard_list.html', {'allcards': allcards})


# def giftcard_upload(request):
#     if request.method == 'POST':
#         form = GiftCardForm(request.POST)
#         if form.is_valid():
#             form.save()
#             return HttpResponseRedirect(reverse('giftcard_list'))
#     else:
#         form = GiftCardForm()
#     return render(request, 'LegacySite/giftcard_upload.html', {'form': form})


# def giftcard_update(request, pk):
#     giftcard = get_object_or_404(GiftCard, pk=pk)
#     if request.method == 'POST':
#         form = GiftCardForm(request.POST, instance=giftcard)
#         if form.is_valid():
#             form.save()
#             return HttpResponseRedirect(reverse('giftcard_list'))
#     else:
#         form = GiftCardForm(instance=giftcard)
#     return render(request, 'LegacySite/giftcard_update.html', {'form': form})


# def giftcard_detail(request, pk):
#     giftcard = get_object_or_404(GiftCard, pk=pk)
#     return render(request, 'LegacySite/giftcard_detail.html', {'giftcard': giftcard})
